...
class DocumentType(str, enum.Enum):
    ...
    TIN_CERTIFICATE = "tin_certificate"  # Optional - can be uploaded OR generated
    INCOME_TAX_3YEARS = "income_tax_3years"  # Optional
    HOTEL_BOOKING = "hotel_booking"  # Optional - can be uploaded OR generated
    AIR_TICKET = "air_ticket"  # Optional - can be uploaded OR generated
    
    # ===== SYSTEM GENERATED DOCUMENTS (13) =====
    ...
    ASSET_VALUATION = "asset_valuation"  # Generated by AI (10-15 pages)
    TIN_CERTIFICATE_GENERATED = "tin_certificate_generated"  # Generated TIN cert
    TAX_CERTIFICATE = "tax_certificate"  # Generated Tax cert
